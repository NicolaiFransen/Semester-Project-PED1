...
For the design and test of the MIC it is of great importance to have the requirements of the system defined. The input requirements of the MIC will be based on the specifications of the PV panel \textit{STP300S-20/Wfb} from Suntech Power. The specifications is shown at table \ref{el_charact_PV_panel}.
...
\begin{table}[H]
	...
	\begin{tabular}{|p{6cm}|>{\centering}p{8cm}|}
		...
		Gain margin ($GM$) &  \tabularnewline \hline
		Phase margin ($PM$) &  \tabularnewline \hline
		Rise time ($t_r$) &  \tabularnewline \hline
		Overshoot ($OS$) &  \tabularnewline \hline
		...
		Maximum dimensions &  \tabularnewline \hline
