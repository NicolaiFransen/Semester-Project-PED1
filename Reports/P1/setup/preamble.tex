...
% Adds support of multi cols and rows
\usepackage{multirow}                		
\usepackage{multicol}         	        
...
%Package used for capital delta letter

\usepackage{ upgreek }

%Packages used for fancy table in switch sizing
%\usepackage[table,xcdraw]{xcolor}
\usepackage[normalem]{ulem}
\useunder{\uline}{\ul}{}

%Package for inserting pdf file in document.
