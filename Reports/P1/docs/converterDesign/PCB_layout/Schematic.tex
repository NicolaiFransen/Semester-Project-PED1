\section{PCB layout}
\subsection{PCB Schematic} \label{voltage_sensors}
In order to proceed with the creation of the PCB, a schematic circuit has been created. This compiles all the previously mentioned components as well as all the passive components for current limiting, decoupling and other needs.
