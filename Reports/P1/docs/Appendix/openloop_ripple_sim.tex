...
Figure \ref{fig:output_voltage_ripple} shows the voltage ripple at the output capacitor. The maximum and minimum voltages are read as $V_{max} = 55.156$ and $V_{min} = 54.879V$, with a mean at $\widebar{V_{out}} = 55.018V$. \todo{Output ripple simulation updated}
