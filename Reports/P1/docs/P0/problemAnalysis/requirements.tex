...
The development of this project will be based on these requirements because they are real commercial products that the user can purchase. 
...
\begin{table}[htbp]
	...
	\label{MIC_req}
\end{table}
\todo{The reference for this table is missing. TL}
