...
The calculated inductance is $1.3 mH$. \todo{Measure inductance behaviour through frequency. As the current component is getting too hot consider creating a new one. Complete inductor selection with final component.}
