...
The calculation of the width has been performed following IPC-2221A section "6.2 Conductive Material Requirements" \todo{Add this to bib file if it isn't there yet and refer to it. Stef} recommendations regarding trace width sizing. First, the needed cross sectional area of the trace must be calculated, as explained in equation \ref{trace_sizing_IPC}.
