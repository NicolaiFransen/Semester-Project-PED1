...
The coil has been cornered since it might induce high interference to other sensible devices, especially the current sensor, which is hall-effect, has been located as far as possible from its influence.\todo{this sentence is to long. After devices a point and the sentence with current sensor should stand for itself  TL} Also the ground plane has been removed from under the inductor in order to reduce interferences.
