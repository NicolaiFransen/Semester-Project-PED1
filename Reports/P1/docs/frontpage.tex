...
\vspace*{\fill}
  ...
  {\color{white}\fboxsep0pt\colorbox{aaublue}{\begin{tabular}{@{}p{\textwidth}@{}}
    \begin{center}
    \Huge{\textbf{
      DC-DC Converter for PV Module Integration% insert your title here
    }}
    \end{center}
    \begin{center}
      \Large{
   ...
   \begin{center}
    {\Large
     Estefanía Ruiz, Aitor Teran, Nicolai Fransen, Jesper Kloster, Thassilo Lang,  Nicolás Murguizur Bustos% insert names separated by comma
    }\\
    \vspace{0.4cm}
    {\large
      Energy Technology, INTRO-760, 2018-12% insert name of study, group number, year-month
    }
   \end{center}
   \vspace{0.2cm}
