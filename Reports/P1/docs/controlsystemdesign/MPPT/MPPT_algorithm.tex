...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=0.3\textwidth]{../Pictures/P1/Flow_chart/flow_chart_perturb_observe}
...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=0.6\textwidth]{../Pictures/P1/Flow_chart/flow_chart_incremental_conductance}
