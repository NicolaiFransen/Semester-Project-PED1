...
\todo{stef the unit for irradiance is not the same format as the other words.I try to fix this but its not working.So write in caption varying temperature and constant irradiance and delete the first row in the table. If you change this, do it for the other table too TL}
...
\todo{it isn't control variable. We call it valg. You describe in caption only the first graph and not the graph below change this TL }
