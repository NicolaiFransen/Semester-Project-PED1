...
\todo{Here comment on the graphs the oscillations with fix and variable step}
\begin{figure}[H]
	\begin{minipage}[c]{0.6\textwidth}
		\centering
...
%10 panels    4.3ohms  299.67W, 1.2seconds, Dbuck = 0.9805, Vin= 36.625, Vout = 35.9 V

%9 panels    5.3 ohms  299.82W, 1.5seconds, Dboost=0.079 , Vin=36.7V , Vout=39.88 
\todo{Here comment the graphs for the boundary}
