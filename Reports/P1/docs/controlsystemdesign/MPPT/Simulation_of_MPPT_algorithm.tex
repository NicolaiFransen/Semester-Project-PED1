...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\textwidth]{../Pictures/constant_temperature}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1\textwidth]{../Pictures/constant_temperature_iv}
