...
*As it can be seen in the boxplots, the response dispersion for the Treated students is more narrow that the one for Control students. Also, the mean value is slightly higher for the Treated students. There are not outliers in any sample*
...
*Also, a point estimate of the mean can be the average yT of the sample upper and lower quartiles.Altough this approximation is good when there are outliers, it is biased when the population is skewed. *
...
*For obtaining this value, is neccesary to calculate the standartd error of the sample difference, as follows:*
